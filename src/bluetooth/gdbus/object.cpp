				...
				struct generic_data *data, const char *path)
{
	...
	for (list = data->interfaces; list; list = list->next) {
		struct interface_data *iface = (interface_data*)list->data;
...
{
	struct generic_data *data = (generic_data*)user_data;
	DBusMessage *reply;
					...
					GDBusPendingReply pending)
{
	...
	for (list = pending_security; list; list = list->next) {
		struct security_data *secdata = (security_data*)list->data;
...
{
	struct builtin_security_data *data = (builtin_security_data*)user_data;
...
{
	struct generic_data *child = (generic_data*) data;
	struct generic_data *parent = (generic_data*) user_data;
...
{
	struct interface_data *iface = (interface_data*) data;
	DBusMessageIter *array = (DBusMessageIter*) user_data;
	...
	append_properties((interface_data*)data, &entry);
...
static const GDBusMethodTable properties_methods[] = {
	{ "Get", properties_get, (GDBusMethodFlags)0, 0, (const GDBusArgInfo[]) { { "interface", "s" }, { "name", "s" }, { } }, (const GDBusArgInfo[]) { { "value", "v" }, { } } },
	{ "Set", properties_set, G_DBUS_METHOD_FLAG_ASYNC, 0, (const GDBusArgInfo[]) { { "interface", "s" }, { "name", "s" }, { "value", "v" }, { } }, 0 },
	{ "GetAll", properties_get_all, (GDBusMethodFlags)0, 0, (const GDBusArgInfo[]) { { "interface", "s" }, { } }, (const GDBusArgInfo[]) { { "properties", "a{sv}" }, { } } },
	{ }
};

static const GDBusSignalTable properties_signals[] = {
	{ "PropertiesChanged", (GDBusSignalFlags) 0, (const GDBusArgInfo[]) { { "interface", "s" }, { "changed_properties", "a{sv}" }, { "invalidated_properties", "as"}, { } } },
	{ }
};
...
static const GDBusMethodTable introspect_methods[] = {
	{"Introspect", introspect, (GDBusMethodFlags)0, 0, 0, (const GDBusArgInfo[]) { { "xml", "s" }, { } }},
	{ }
};
...
static const GDBusMethodTable manager_methods[] = {
	{"GetManagedObjects", get_objects, (GDBusMethodFlags)0, 0, 0, (const GDBusArgInfo[]) { { "objects", "a{oa{sa{sv}}}" }, { } }},
	{ }
};

//static const GDBusSignalTable manager_signals[] = {
 //{ .name = "InterfacesAdded", .args = (const GDBusArgInfo[]) { { "object", "o" }, "interfaces", "a{sa{sv}}" }, { } } },
 //{ .name = "InterfacesRemoved", .args = (const GDBusArgInfo[]) { { "object", "o" }, { "interfaces", "as" }, { } } },
 //{ }
//};
...
static const GDBusSignalTable manager_signals[] = {
	{ "InterfacesAdded", (GDBusSignalFlags)0, (const GDBusArgInfo[]) { { "object", "o" }, "interfaces", "a{sa{sv}}" }},
	{ "InterfacesRemoved", (GDBusSignalFlags)0, (const GDBusArgInfo[]) { { "object", "o" }, { "interfaces", "as" }, { } }},
	{ }
};
...
{
	struct generic_data *data = (generic_data*)NULL;
...
static void g_dbus_flush(DBusConnection *connection)
{
	...
	for (l = pending; l;) {
		struct generic_data *data = (generic_data*)l->data;
						...
						struct interface_data *iface)
{
	...
	for (l = iface->pending_prop; l != NULL; l = l->next) {
		GDBusPropertyTable *p = (GDBusPropertyTable*)l->data;
...
static void process_property_changes(struct generic_data *data)
{
	...
	for (l = data->interfaces; l != NULL; l = l->next) {
		struct interface_data *iface = (interface_data*)l->data;
