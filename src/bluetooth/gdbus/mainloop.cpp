...
{
	struct disconnect_data *dc_data = (disconnect_data*) data;
...
static dbus_bool_t add_watch(DBusWatch *watch, void *data)
{
	...
	if (flags & DBUS_WATCH_READABLE) cond  = (GIOCondition) ((int)cond | ((int) G_IO_IN));
	if (flags & DBUS_WATCH_WRITABLE) cond  = (GIOCondition) ((int)cond | ((int) G_IO_OUT));
...
{
	struct timeout_handler *handler = (timeout_handler*) data;
